#ifndef GAME_LOGIC_COMPONENTS_SPRITE_COMPONENT_H_
#define GAME_LOGIC_COMPONENTS_SPRITE_COMPONENT_H_
...
struct SpriteComponent {
  ...
  engine::math::RectF source_rect{0.0f, 0.0f, 32.0f, 32.0f};
  ...
  SpriteComponent(std::string path, const engine::math::RectF& rect)
      : texture_path(std::move(path)), source_rect(rect) {}
};

}  // namespace game_logic::components

#endif  // GAME_LOGIC_COMPONENTS_SPRITE_COMPONENT_H_