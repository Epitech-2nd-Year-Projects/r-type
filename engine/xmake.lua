...
target("engine")
    set_kind("phony")
    add_deps("engine_core", "engine_util", "engine_math", "engine_time", "engine_event", "engine_resource", "engine_ecs", "engine_input", "engine_net", "engine_audio", "engine_render", "engine_ui", "engine_profiling", "engine_scripting", "engine_app")
