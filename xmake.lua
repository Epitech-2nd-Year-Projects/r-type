...
package("ffmpeg-prebuilt")
    set_homepage("https://www.gyan.dev/ffmpeg/builds/")
    set_description("Prebuilt FFmpeg binaries")
    set_license("LGPL-2.1")
    set_urls("https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-$(version)-full_build-shared.7z")
    add_versions("7.1", "411d0ae70b72d16f0049696b525a1e24774cacc08fbc30caf042c291c9df43b9")
    ...
    on_install("windows", function (package)
        ...
        local root = "ffmpeg-" .. version .. "-full_build-shared"
