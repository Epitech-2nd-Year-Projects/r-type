...
package("ffmpeg-prebuilt")
    ...
    set_urls("https://github.com/BtbN/FFmpeg-Builds/releases/download/autobuild-2026-01-17-13-00/ffmpeg-n$(version)-latest-win64-lgpl-shared-$(version).zip")
    add_versions("7.1", "b10df74658d3f57dfd24a6a9cb81d4b9c2b5b77ea53cda13ee692f0047b21945")
