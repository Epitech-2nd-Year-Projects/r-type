...
MainMenuScene::MainMenuScene(Application& app) : app_(app) {
  ...
  ui_elements_.push_back(std::make_shared<ui::Label>(
      engine::math::Vector2f{center_x - 120.0f, 80.0f}, "R-Type", 60.0f,
      white));

  ui_elements_.push_back(std::make_shared<ui::Label>(
      engine::math::Vector2f{center_x - 200.0f, start_y}, "Server Address",
      20.0f, white));
  host_input_ = std::make_shared<ui::TextInput>(
      engine::math::Vector2f{center_x - 200.0f, start_y + 25.0f},
  ...
  start_y += 90.0f;
  ui_elements_.push_back(std::make_shared<ui::Label>(
      engine::math::Vector2f{center_x - 200.0f, start_y}, "Port", 20.0f,
      white));
  ...
  start_y += 90.0f;
  ui_elements_.push_back(std::make_shared<ui::Label>(
      engine::math::Vector2f{center_x - 200.0f, start_y}, "Nickname", 20.0f,
      white));
  ...
  auto connect_btn = std::make_shared<ui::Button>(
      ...
      engine::math::Vector2f{400.0f, 50.0f}, "Connect", [this]() {
  ...
  auto settings_btn = std::make_shared<ui::Button>(
      engine::math::Vector2f{center_x - 200.0f, start_y},
      engine::math::Vector2f{400.0f, 50.0f}, "Settings",
